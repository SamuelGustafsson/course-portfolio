$(document).ready(function () {
      ...
      function renderTestimonials(testimonialsArray) {
            ...
            for (var i = 0; i < testimonialsArray.length; i++) {
                  ...
                  var testimonialHTML = '<div class="testimonial-slider-item col-sm-12">';
      ...
      function playSlider() {
            ...
            $(sliderNavControlsContainer[counter]).addClass("current");
            counter++
      }
      ...
      function changeTestimonial(buttonClicked) {
            ...
            console.log(counter);
            if (counter == 0) {
                  counter = sliderNavButtons.length;
            }
            else if (counter === sliderNavButtons.length) {
                  counter = 0;
            }
            ...
            // Update nav control
            $(sliderButtons[current]).addClass("current");
            counter++;
            // Reset interval
